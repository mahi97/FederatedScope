...
TRAINER_CLASS_DICT = {
    ...
    "mapatrainer": "MAPATrainer", # added by Mahi
    "svdtrainer": "SVDTrainer",
    "llmsvdtrainer": "LLMSVDTrainer",
}
...
def get_trainer(model=None,
    ...
    if config.trainer.type == 'general':
        ...
        elif config.trainer.type.lower() in ['mapatrainer']:
            dict_path = "federatedscope.glue.trainer.mapa_trainer"
        elif config.trainer.type.lower() in ['svdtrainer']:
            dict_path = "federatedscope.glue.trainer.svd_trainer"
        elif config.trainer.type.lower() in ['llmsvdtrainer']:
            dict_path = "federatedscope.llm.trainer.svd_trainer"
        else:
            raise ValueError
