...
def extend_aggregator_cfg(cfg):
    ...
    # Variants for LoRA/SVD aggregation.
    # `svd`: current low-rank averaging path
    # `fedma`: row-alignment averaging path
    # `full_rank`: average BA in full rank, then factorize back to LoRA
    cfg.aggregator.svd_mode = 'svd'
