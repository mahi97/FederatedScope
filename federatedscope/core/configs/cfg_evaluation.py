...
def extend_evaluation_cfg(cfg):
    ...
    cfg.eval.llm = CN()
    cfg.eval.llm.use_generation = True
    cfg.eval.llm.reuse_train_model = False
    cfg.eval.llm.compile_model = False
    cfg.eval.llm.show_progress = True
    cfg.eval.llm.batch_size = 4
