...
def extend_llm_cfg(cfg):
    ...
    cfg.llm.gradient_checkpointing = False
    cfg.llm.torch_compile = False
    ...
    cfg.llm.cache.model = os.environ.get(
        'HF_HOME',
        os.path.join(_storage, 'huggingface') if _storage else '',
    )
    ...
    # ---------------------------------------------------------------------- #
    # GSM8K-related fast debug options
    # ---------------------------------------------------------------------- #
    cfg.llm.gsm8k = CN()
    cfg.llm.gsm8k.train_size = -1
    cfg.llm.gsm8k.val_size = 256
    cfg.llm.gsm8k.test_size = -1
    cfg.llm.gsm8k.eval_max_samples = -1
    cfg.llm.gsm8k.max_new_tokens = 256
    cfg.llm.gsm8k.n_shot = 3
    cfg.llm.gsm8k.cot = True
    cfg.llm.gsm8k.sample_seed = 42
