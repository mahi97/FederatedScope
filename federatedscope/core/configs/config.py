...
def init_global_cfg(cfg):
    ...
    # Whether to use Gram matrix for aggregation
    cfg.use_gram = False
    
    cfg.mapa_rank = 1000 # added by Mahi
    ...
    cfg.outdir = os.environ.get('APRILS_EXP_DIR',
                                os.environ.get('APRILS_OUTPUT_DIR', 'exp'))
