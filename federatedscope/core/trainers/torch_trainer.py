...
class GeneralTorchTrainer(Trainer):
    ...
    def register_default_hooks_eval(self):
        # pass
        # test/val
        self.register_hook_in_eval(self._hook_on_fit_start_numerical_precision,"on_fit_start")
    ...
    def _hook_on_epoch_start2(self, ctx):
    ...
    def _hook_on_batch_start_init2(self, ctx):
        # pass
        try:
