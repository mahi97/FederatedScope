#!/bin/sh
# run_online.sh – run experiments in ONLINE mode.
# Missing models/datasets will be downloaded automatically on first use
# and stored under $STORAGE_ROOT for future offline runs.
